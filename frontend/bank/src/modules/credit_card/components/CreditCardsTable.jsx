...
function CreditCardsTable() {
    ...
    useEffect(() => {
        axios.get(API_BASE_URL + '/cards/credit').then((resp) => {
    ...
    const orderCreditCard = () => {
        axios.post(API_BASE_URL + '/cards/credit/order').then((resp) => {
            setCardList(resp.data);
        });
    }
                                    ...
                                    <tbody>
                                        {cardList.map((card, index) => (
                                            <tr>
                                                ...
                                                <td>
                                                    <NavLink to={'/cards/credit/' + card.id}
